...
BEGIN
  ...
  -- Cláusula clínica de salário fixo: receita do paciente = 0.
  ...
  -- ============================================================================
  -- Pacote no cadastro do paciente: mantém regras antigas
  -- ============================================================================
  ...
  -- ============================================================================
  -- Caso geral: valor por sessão = procedimento do agendamento (prioridade),
  -- depois fallback para payment_value.
  -- ============================================================================
  FOR _evo IN
  ...
  LOOP
    IF _evo.group_id IS NOT NULL THEN
      ...
      END IF;
    ELSE
      -- Resolve valor da sessão a partir do agendamento da mesma data
      _appt_proc_id := NULL;
      _appt_pkg_id := NULL;
