...
import { Home, MessageSquare, FileText, LogOut, Bell, DollarSign, FolderOpen, Newspaper, BookOpen, ClipboardList, BookHeart } from 'lucide-react';
...
const navItems = [
  ...
  { to: '/portal/diario', icon: BookHeart, label: 'Diário' },
